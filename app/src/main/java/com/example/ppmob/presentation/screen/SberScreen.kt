...
@Composable
fun SberScreen(navController: NavHostController) {
    Column(
        modifier = Modifier
        ...
        Text(
            text = "Требования СберБанка по составу документов",
        ...
        Row(
            ...
            Text(
                text = "Сертификат резидентства (для нерезидентов)",
                fontFamily = RadioCanadaRegular,
                fontSize = 15.sp,
                color = Color.Black,
                modifier = Modifier.weight(1f)
            ...
            Text(
                text = "Если есть операции с материнской компанией",
                fontFamily = RadioCanadaRegular,
                fontSize = 15.sp,
                color = Color(0xFF696969),
                modifier = Modifier.weight(1f).padding(start = 10.dp)
        ...
        Row(
            ...
            Text(
                text = "Заполняется в системе банка",
                fontFamily = RadioCanadaRegular,
                fontSize = 15.sp,
                color = Color(0xFF696969),
                modifier = Modifier.weight(1f).padding(start = 10.dp)
