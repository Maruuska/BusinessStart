...
object NavRoutes {
    ...
    const val docWithParam = "document_screen/{needApostille}/{isSimplified}"

    fun docWithParam(needApostille: Boolean, isSimplified: Boolean = false): String {
        return "document_screen/$needApostille/$isSimplified"
    }
